...
{setup_yaml}
      - uses: hippoley/CounterProof@{action_ref}
        with:
    ...
    *,
    ...
    if require_witness and "{tests}" not in test_command:
        ...
        raise ValueError(
            ...
            "--strict/--require-witness requires a precise command containing {tests}. "
            "Use advisory SUITE DELTA mode, or pass --test-command with an explicit "
            "{tests} placeholder."
        )
